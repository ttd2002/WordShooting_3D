...
public class BulletImpact : WMonoBehaviour
{
    ...
    protected virtual void OnTriggerEnter(Collider other)
    {
        ...
        Transform vfx_Impact = VFXSpawner.Instance.Spawn(VFXSpawner.impact, other.transform.position, other.transform.rotation);
        ...
        {
            ScoreController.Instance.AddScore();
            ScoreController.Instance.AddBonusScore();

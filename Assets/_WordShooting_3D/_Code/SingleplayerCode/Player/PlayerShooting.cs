...
public class PlayerShooting : MonoBehaviour
{
    ...
    {
        ShootingManagment.OnResetAllTargets += ResetTarget;
    }
    ...
    {
        Transform vfx_Muzzle = VFXSpawner.Instance.Spawn(VFXSpawner.muzzle, firePoint.position, firePoint.rotation);
        vfx_Muzzle.gameObject.SetActive(true);
    }
    private void SpawnBullet(string namPrefab, Transform targetTextComponent)
    {
        Transform bullet = BulletSpawner.Instance.Spawn(namPrefab, firePoint.position, firePoint.rotation);

...
public abstract class ParentFly : WMonoBehaviour
{
    ...
    {
        Vector3 centerPos = targetTrans.GetComponent<Monster>().GetHitPos();
        ...
        transform.parent.position = Vector3.MoveTowards(transform.parent.position, centerPos, this.moveSpeed * Time.deltaTime);
    }
